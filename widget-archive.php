...
class distinctive_themes_archive extends WP_Widget {

	function distinctive_themes_archive() {
		$widget_ops = array( 'classname' => 'distinctive_themes_archive_widget', 'description' => 'Search in Archive');
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'distinctive_themes_archive_widget' );
		parent::__construct( 'distinctive_themes_archive_widget', 'DistinctiveThemes: Archive Search', $widget_ops, $control_ops);
	}	
			...
			?>
				<div style="background:<?php echo esc_attr( $bgcol ); ?>">
					...
					<form action="<?php echo esc_url( home_url( '/' ) ); ?>"  method="get" > 
						...
						<?php wp_dropdown_categories('show_option_none='. __('Click to Select','distinctive_themes-widget-pack') .'&orderby=Name&hierarchical=1&nwsp_count=1'); ?>
					</form>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('date'); ?>"><?php _e('Label for Search by Date','distinctive_themes-widget-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('month'); ?>"><?php _e('Date selectbox placeholder text','distinctive_themes-widget-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('cat'); ?>"><?php _e('Category selectbox placeholder text','distinctive_themes-widget-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('google'); ?>"><?php _e('Google search label','distinctive_themes-widget-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('google_df'); ?>"><?php _e('Google field input placeholder text','distinctive_themes-widget-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('bgcol'); ?>"><?php _e('Background color (eg #fff or white)','distinctive_themes-widget-pack'); ?></label>
...
function register_widgetname() {
	register_widget('distinctive_themes_archive');
}
